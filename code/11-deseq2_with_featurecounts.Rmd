...
write.table(sigresults,"../output/0731-DEGstats_filtered10r5n.tab", row.names = T, col.names = T)

# peeking at sigresults
sigres_table <- read.csv("../output/0731-DEGstats_filtered10r5n.tab", sep="")
head(sigres_table)

sigDEGname <- row.names(sigres_table)

write.table(sigDEGname, "../output/0727-DEGnames_filtered10r5n.tab", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
...
all_deg <- row.names(res_ordered)[1:77]
...
write.csv(log_counts_deg, "../output/0731-logcounts_allDEG_filtered10r5n.csv")

# Open a PNG device to save the plot
png("../output/0731-DEG_heatmap_10r5n_unc.png", width = 1000, height = 1000)

# Generate the heatmap
pheatmap(log_counts_deg, 
         scale = "row", 
         cluster_cols = FALSE,
         main = "Heatmap All DEGs (padj < 0.05, pre-filtered 10r5n")

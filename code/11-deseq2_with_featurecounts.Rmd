...
# Save the results
write.table(res2, "../output/0807-deseqres_ToC_8ind23r.tab", row.names = TRUE, col.names = TRUE)
...
# Open a PNG device to save the plot
png("../output/0807-DEG_heatmap_8ind23r_ToC_clust.png", width = 1000, height = 1000)

# Generate the heatmap
pheatmap(log_counts_deg, 
         scale = "row", 
         cluster_cols = TRUE,
         main = "Heatmap All DEGs (padj < 0.05, 23r 8ind ToC clustered")

...
### Filtered: Heatmap of All (54) Sig. DEG
...
write.csv(log_counts_top, "../output/log_counts_all_filtered.csv")

# Open a PNG device to save the plot
png("../output/heatmap_all_DEGs_filtered.png")

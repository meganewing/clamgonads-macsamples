...
rphil.blast.cds <- right_join(rphil.blast.cds.headers,
                            read_delim(file = "../output/rphil_blastout_cds.tab",
                                       delim = "\t", 
...
write.table(rphil.blast.cds,"../output/rphil_blast_cds.tab", col.names = T)
...
# Save best hits
write.table(best_hits, "../output/blast_out_gene_level_20240709.txt", sep = "\t", row.names = FALSE, col.names = TRUE)

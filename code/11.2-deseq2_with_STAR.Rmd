...
counts_control <- counts(dds)[, 1:14]
counts_treatment <- counts(dds)[, 15:29]
...
# Save the results
write.table(res2, "../output/1018-STAR-deseqres_ToC_8ind23r.tab", row.names = TRUE, col.names = TRUE)
...
```{r}
allcounts <- read.csv("../output/1018-STAR-deseqres_ToC_8ind23r.tab", sep="")
head(allcounts)
...
write.table(sigresults,"../output/1018-STAR-DEGstats_ToC_8ind23r.tab", row.names = T, col.names = T)

# peeking at sigresults
sigres_table <- read.csv("../output/1018-STAR-DEGstats_ToC_8ind23r.tab", sep="")
head(sigres_table)
...
all_deg <- row.names(res_ordered)[1:219]
...
# Open a PNG device to save the plot
png("../output/1018-STAR-DEG_heatmap_8ind23r_ToC.png", width = 500, height = 700)
